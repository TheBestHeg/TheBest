...
export default function Admin_ajouter_carton({visible, onClose}) {
    ...
    function searchMatch(e){
      ...
      function submit(e){
        e.preventDefault();
        var idArbitre = null;
        axios.get("/api/matchs/"+data.match).then((res) => {
          idArbitre = res.data.arbitre;
          alert(idArbitre);
          console.log(data.match)
        if (data.minute != null && data.joueur!= null && data.match != null){
          axios.post("/api/cartons/insert/",{
            minute:data.minute,
        ...
        <div className="bg-white p-2 rounded w-72">
          ...
          <div class="">
                ...
                <div class="">
                  ...
                  <select onChange={(e)=>handle(e)} id="couleur" class="form-select appearance-none
        block
        w-full
        px-8
        py-1.5
