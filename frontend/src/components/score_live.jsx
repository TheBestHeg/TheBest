...
const Score_live = () => {
  ...
  useEffect(() => {
    axios.get("/api/matchs/" + id).then((res) => {
      setMatch(res.data);
      setMinutes(calculateHeureLive(res.data.heure))
  ...
  return <div>
    ...
    <div class="px-16 py-20">
      <div>
        {/* Navbar */}
        <h1 className="text-center text-2xl font-bold mb-6 mt-12">Score en live</h1>
        <div className="flex lg:flex-row flex-col lg:justify-center lg:gap-72 mb-12">
          <div className="lg:mt-12">
            ...
            {/* temps de jeu */}
            <div className="slidecontainer flex flex-col items-center">
              <input type="range" min={1} max={96} value={minutes} className="w-96 bg-black" id="myRange" />
              <h1 className="my-8">{minutes}ème minute</h1>
            </div>
            {/* buteur */}
