...
const Details_match = () => {
    ...
    <div className="flex justify-evenly">
      <div className="flex flex-row gap-2">
        <a className="font-bold"> 26'</a>
        <a>K. Imeri</a>
        <a className="font-bold"> 84'</a>
        <a>K. Imeri</a>
      </div>
      <div className="flex flex-row gap-2">
        <a className="font-bold">34' </a>
        <a>S. Esposito</a>
      </div>
    </div>
          ...
          <div className="flex bg-white border border-gray-300 rounded-xl overflow-hidden items-center justify-start" style={{cursor: 'auto'}}>
            <div className="relative w-32 h-32 flex-shrink-0">
              <div className="absolute left-0 top-0 w-full h-full flex items-center justify-center">
                <img alt="Placeholder Photo" src="./images/IMG_0528.JPG" className="absolute left-0 top-0 w-full h-full object-cover object-center transition duration-50" loading="lazy" />
              </div>
            </div>
            <div className="p-4">
