...
const Acceuil = () => {
    return <div class="bg-[#c1f7a6] px-16 py-8">
        <div class="grid grid-cols-9 gap-2 content-center">
        <img src={logo} alt="" class="w-40 col-span-7"/>
        <Link to={"/login"}>
          <button class="bg-blue-700 hover:bg-blue-500 text-white font-bold py-2 px-4 rounded-full w-44 h-14" >Se connecter</button>
        </Link>
