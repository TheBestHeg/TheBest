    ...
    return <div class="bg-[#c1f7a6] px-16 py-8">
        <div>
            ...
            <div className="flex justify-center mt-6">
                <h2 className="font-bold">Championnat 3ème ligue</h2>
            </div>
            ...
            <div className="flex lg:flex-row flex-col lg:justify-center items-center">
                    ...
                    <div className="h-64 w-60 bg-red-400 rounded-b-lg">
                        ...
                        <div className="flex justify-center">
                            <div className="mb-12 mt-2">
                                <h1 className="text-center">Fc. Aïre le lignon</h1>
                                <h1 className="text-center">Nb buts : 25</h1>
                            </div>
                        </div>
                        <div className="flex justify-center">
                            <h2 className="font-bold">Notes Moyennes : 8.5</h2>
                        </div>
                    </div>
                </div>
                <div className="m-6">
                    ...
                    <div className="h-64 w-60 bg-[#edf0a1] rounded-b-lg">
                        ...
                        <div className="flex justify-center">
                            <div className="mb-12 mt-2">
                                <h1 className="text-center">Fc. Vernier</h1>
                                <h1 className="text-center">Nb de passe déc. : 16</h1>
                            </div>
                        </div>
                        <div className="flex justify-center">
                            <h2 className="font-bold">Notes Moyennes : 8.5</h2>
                ...
                <div className="m-6">
                    ...
                    <div className="h-64 w-60 bg-[#9ddae4] rounded-b-lg">
                        ...
                        <div className="flex justify-center">
                            <div className="mb-12 mt-2">
                                <h1 className="text-center">Fc. Etoile Carouge</h1>
                                <h1 className="text-center">Buts encaissé : 5</h1>
                            </div>
                        </div>
                        <div className="flex justify-center">
                            <h2 className="font-bold">Notes Moyennes : 9.1</h2>
                        </div>
                    </div>
                </div>
            </div>
